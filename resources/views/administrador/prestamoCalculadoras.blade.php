...
<div class="flex flex-col min-h-screen p-8 bg-white">
    ...
    <h2 class="text-2xl font-bold mb-6" style="margin-left: 5vw;">Préstamos de calculadoras</h2>
    <div class="flex justify-center items-center">
        <div class="bg-gray-100 shadow-md rounded-lg p-8 w-2/3">
            <form>
                ...
                <button type="submit" class="bg-[#2DB4D1] text-white py-2 px-9 rounded-lg hover:bg-[#2DB4D1] transition duration-200">PRESTAR</button>
