...
<div class="flex flex-col min-h-screen p-8 bg-white">
    ...
    <h2 class="text-2xl font-bold mb-6" style="margin-left: 5vw;">Reserva de salas de estudio</h2>
    <div class="flex justify-center items-center">
        <div class="bg-gray-100 shadow-md rounded-lg p-8 w-2/3">
            <form>
                ...
                <div class="mb-4">
                    <label for="fechas" class="block text-gray-700 mb-2">Seleccionar fecha</label>
                ...
                <div class="mb-6 mt-6">
                    <label for="idioma" class="block text-gray-700 mb-2">Seleccionar sala</label>
