...
<div class="flex flex-col lg:flex-row min-h-screen">
    <!-- Imagen del lado izquierdo ocupando el 30% del ancho y 100% de la altura en pantallas grandes, y 100% del ancho en pantallas pequeñas -->
    <!-- <div class="w-full lg:w-1/3 h-64 lg:h-screen">
        <img src="{{ asset('images/administracion.png') }}" alt="Imagen de administración" class="w-full h-full object-cover">
    </div> -->
    <!-- Contenido del lado derecho ocupando el 70% del ancho en pantallas grandes, y 100% del ancho en pantallas pequeñas con margen interno -->
    <div class="w-full lg:w-2/3 flex flex-col p-8" style="margin-right: 2vw;">
        ...
        <div class="flex items-center mb-6">
            ...
            <h2 class="text-2xl font-bold">Préstamos de recursos</h2>
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <!-- Tarjeta 1 -->
            <div class="bg-white rounded-lg shadow-md p-4 w-full">
                <div class="h-32 bg-gray-300 rounded-md mb-4"></div>
                <h3 class="text-lg font-semibold mb-2">Préstamos de tablets</h3>
            ...
            <div class="bg-white rounded-lg shadow-md p-4 w-full">
                <div class="h-32 bg-gray-300 rounded-md mb-4"></div>
                <h3 class="text-lg font-semibold mb-2">Préstamo de calculadoras</h3>
                <p class="text-gray-600 mb-1">
                    <svg class="inline w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 17l4 4 4-4M8 12l4 4 4-4"></path>
                    </svg>
            ...
            <div class="bg-white rounded-lg shadow-md p-4 w-full">
                <div class="h-32 bg-gray-300 rounded-md mb-4"></div>
                <h3 class="text-lg font-semibold mb-2">Préstamos de libros</h3>
                <p class="text-gray-600 mb-1">
                    <svg class="inline w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 17l4 4 4-4M8 12l4 4 4-4"></path>
                    </svg>
