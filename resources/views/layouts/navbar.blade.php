...
<div class="bg-gray-200 text-black/65">
    <div class="w-full">
        <header>
            @if (Route::has('login'))
                <nav class="px-8 flex items-center justify-between py-2 bg-dark_black" x-data="data()" x-init="start()">
                    <div class="flex flex-row md:w-fit items-center justify-between">
                        <a href="{{ route('/') }}" class="flex flex-col text-center text-white py-1">
                            <span class="text-3xl leading-none font-bold">CEDITEC</span>
                            <span class="text-[10px] leading-none font-normal">Centro de Documentación<br>e Información</span>
                        </a>
                    </div>
                    ...
                    <div class="hidden md:flex items-center">
                        <ul class="flex flex-row gap-[2vw]">
                            <li><a href="{{ route('/') }}" class="nav-link">Inicio</a></li>
                            <li><a href="{{ route('repositorio') }}" class="nav-link">Repositorio</a></li>
                            <li><a href="{{ route('catalogo') }}" class="nav-link">Catálogo</a></li>
                            <li><a href="{{ route('acerca') }}" class="nav-link">Nosotros</a></li>
                            @auth
                                <li><a href="{{ route('perfil') }}" class="nav-link">Perfil</a></li>
                            @else
                                <li><a href="{{ route('login') }}" class="nav-link">Inicia sesión</a></li>
                                <li><a href="{{ route('administrador') }}" class="nav-link">Administración</a></li>
                            @endauth
                        </ul>
                    </div>
...
>>>>>>> fefd44e45ad8830cc3132887a57f86f3929d5620
