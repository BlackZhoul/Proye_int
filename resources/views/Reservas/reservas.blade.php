...
<div class="container mx-auto p-4">
    ...
    <div class="flex items-center mb-6">
        <img src="{{ asset('images/reserva.png') }}" class="w-10 h-10 mr-2" alt="Reservas">
        <span class="text-2xl font-semibold">Reservas</span>
    </div>

    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-2">
        <div class="bg-white rounded-lg shadow-md text-center overflow-hidden">
            <img src="{{ asset('images/sala.jpg') }}" class="w-full h-48 object-cover" alt="Sala de Estudio">
            <div class="p-6">
                <p class="font-semibold text-xl mb-2">Reserva de Sala de Estudio</p>
        ...
        <div class="bg-white rounded-lg shadow-md text-center overflow-hidden">
            <img src="{{ asset('images/computadora.jpg') }}" class="w-full h-48 object-cover" alt="Computadoras">
            <div class="p-6">
                <p class="font-semibold text-xl mb-2">Reserva de Computadoras</p>
                <div class="flex justify-center items-center mb-2">
                    <img src="{{ asset('images/hora.png') }}" class="w-6 h-6 mr-2" alt="Icono de Tiempo">
                    <span>1 a 2 horas al día</span>
                </div>
